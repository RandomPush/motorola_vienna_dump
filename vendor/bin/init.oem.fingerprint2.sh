...
vendor_list=('egis' 'jiiov')
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/ets_fod_mmi_u.ko" "/vendor/lib/modules/$GKI_PATH/anc_fps_mmi.ko")
kernel_so_name_list=("ets_fod_mmi_u.ko" "anc_fps_mmi.ko")
hal_list=('ets_hal' 'jv_hal')
...
function start_hal_service(){
    ...
    log "skip remove kernel so: ${kernel_so_name_list[$1]} "
